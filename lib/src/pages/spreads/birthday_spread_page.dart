...
class BirthdaySpreadPage extends StatefulWidget {
  final int index;

  BirthdaySpreadPage(this.index);

  @override
  _BirthdaySpreadPageState createState() => _BirthdaySpreadPageState();
}

class _BirthdaySpreadPageState extends State<BirthdaySpreadPage> {
  bool accepted = false;
