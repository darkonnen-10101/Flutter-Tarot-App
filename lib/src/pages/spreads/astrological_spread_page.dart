...
class AstrologicalSpreadPage extends StatefulWidget {
  final int index;

  AstrologicalSpreadPage(this.index);

  @override
  _AstrologicalSpreadPageState createState() => _AstrologicalSpreadPageState();
}

class _AstrologicalSpreadPageState extends State<AstrologicalSpreadPage> {
  bool accepted = false;
