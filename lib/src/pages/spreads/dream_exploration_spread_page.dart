...
class DreamExplorationSpreadPage extends StatefulWidget {
  final int index;

  DreamExplorationSpreadPage(this.index);

  @override
  _DreamExplorationSpreadPageState createState() =>
      _DreamExplorationSpreadPageState();
}

class _DreamExplorationSpreadPageState
    extends State<DreamExplorationSpreadPage> {
  bool accepted = false;
