...
class RelationshipSpreadPage extends StatefulWidget {
  final int index;

  RelationshipSpreadPage(this.index);

  @override
  _RelationshipSpreadPageState createState() => _RelationshipSpreadPageState();
}

class _RelationshipSpreadPageState extends State<RelationshipSpreadPage> {
  bool accepted = false;
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text(
                          S.of(context).spreadRelationship,
                          style: GoogleFonts.galada(
                            color: Colors.white,
                            fontSize: 20.0,
                          ),
