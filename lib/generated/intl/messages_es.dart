...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "spreadCelticCross" : MessageLookupByLibrary.simpleMessage(""),
    "spreadCrossAndTriangle" : MessageLookupByLibrary.simpleMessage(""),
    "spreadDreamExploration" : MessageLookupByLibrary.simpleMessage(""),
    "spreadMandala" : MessageLookupByLibrary.simpleMessage(""),
    "spreadPastLife" : MessageLookupByLibrary.simpleMessage(""),
    "spreadPlanetary" : MessageLookupByLibrary.simpleMessage("Esta es la información de la tirada \nesto es un salto de línea Esta es la información de la tirada \nesto es un salto de línea Esta es la información de la tirada \nesto es un salto de línea Esta es la información de la tirada \nesto es un salto de línea Esta es la información de la tirada \nesto es un salto de línea Esta es la información de la tirada \nesto es un salto de línea Esta es la información de la tirada \nesto es un salto de línea Esta es la información de la tirada \nesto es un salto de línea Esta es la información de la tirada \nesto es un salto de línea"),
    "spreadRelationship" : MessageLookupByLibrary.simpleMessage(""),
    "spreadStarGuide" : MessageLookupByLibrary.simpleMessage(""),
    "spreadTetraktys" : MessageLookupByLibrary.simpleMessage(""),
